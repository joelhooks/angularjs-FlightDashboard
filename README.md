...
And if this somewhat trivial example does  not convince you... check out a real-world [refactor of the Dash.js](https://gist.github.com/ThomasBurleson/7576083) class `DownloadRules.js`.
